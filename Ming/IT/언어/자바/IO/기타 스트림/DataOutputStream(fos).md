...
##### 장점
- DataStream을 사용하면 자바 타입을 그대로 사용하고 구분자를 사용 안 해도 된다.
- 모든 데이터를 문자로 저장할 때 보다 더 최적화 할 수 있다.
	- EX : 숫자의 1,000,000,000(10억)을 문자로 저장하게되면 총 10byte 사용된다. 하지만 DataStream에 `writeInt()` 사용하면 4byte만 사용해도 된다.
##### 주의 
